...
public class DogeFlow extends OpMode {
    ...
    public void init() {
        ...
        vuforia = new Tensorforia(parameters);
        ...
        Log.e("Ivan, ", "Right before vuforia.start()");
        vuforia.start();
        Log.e("Ivan, ", "Right after vuforia.start()");
    ...
    public void loop() {
        ...
        telemetry.addData("Gold Position: ", imageClassifier.classifyFrame(vuforia.getBitmapFromRenderQueue()));
